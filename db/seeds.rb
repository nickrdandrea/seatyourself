...
User.new(first_name: 'Wayne',last_name: 'Gretzky' ,email: 'wayne@gmail.com' ,phone: '1234567890',username: 'WayneG',password: 'password')
User.new(first_name: 'Yonas',last_name: 'Brothers' ,email: 'yonas@gmail.com' ,phone: '1234567890',username: 'YonasB',password: 'password')
User.new(first_name: 'Joey',last_name: 'TheKangaroo' ,email: 'joey@gmail.com' ,phone: '1234567890',username: 'JoeyTK',password: 'password')
User.new(first_name: 'Nick',last_name: 'Knack' ,email: 'nick@gmail.com' ,phone: '1234567890',username: 'NickK',password: 'password')
#
